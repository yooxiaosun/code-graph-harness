...
FIXTURES_DIR="${3:-scripts/extractors/nonstandard/fixtures}"
...
case "$SCRIPT_NAME" in
    extract-http-client|*http*)   SAMPLE_DIR="$FIXTURES_DIR/sample-http-client" ;;
    extract-mq|*mq*)              SAMPLE_DIR="$FIXTURES_DIR/sample-mq" ;;
    extract-custom|*socket*|*custom*) SAMPLE_DIR="$FIXTURES_DIR/sample-socket" ;;
