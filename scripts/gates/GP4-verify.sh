...
case "$SCRIPT_NAME" in
    *http*)            EXPECTED_FILE="$EXPECTED_DIR/http-client.json"; SAMPLE_DIR="$FIXTURES_DIR/sample-http-client" ;;
    *mq*)              EXPECTED_FILE="$EXPECTED_DIR/mq.json"; SAMPLE_DIR="$FIXTURES_DIR/sample-mq" ;;
    *socket*|*custom*) EXPECTED_FILE="$EXPECTED_DIR/socket.json"; SAMPLE_DIR="$FIXTURES_DIR/sample-socket" ;;
